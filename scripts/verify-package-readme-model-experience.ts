...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/tui': { kind: 'none', reason: 'The REPL runner submits typed lines, steering, and interaction answers through the composed packages\' own seams; prompts and tools belong to the composed base and tui bundles.' },
